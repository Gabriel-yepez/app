...
export const Pago = () => {
  ...
  return (
    <div className="flex flex-col justify-center w-full min-h-screen pt-16 sm:pt-18 bg-gray-100">
      ...
      <h1 className={`${tittleFont.className} text-2xl font-bold mb-5 text-center`}>Registrar pago</h1>
      ...
      <div className="relative z-20 flex flex-col justify-center items-center">
        ...
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
          ...
          <label htmlFor="name" className="py-1 block text-sm font-medium text-gray-700">Fecha:</label>
          <input
            type="date"
            id="name"
            name="name"
          ...
          <label htmlFor="name" className="py-1 block text-sm font-medium text-gray-700">Monto:</label>
          <input
            type="number"
            id="name"
            name="name"
